<%@page import="com.avia.exchange.UserRequest"%>
...
if (jsonInput!=null && !jsonInput.isEmpty()) {
			...
			UserRequest userRequest = gson.fromJson(jsonInput, UserRequest.class);	
			
			BookingDb db = new BookingDb();
			
			String jsonOutput = db.getBookingHistory(userRequest);
